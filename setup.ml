(* OASIS_START *)
(* DO NOT EDIT (digest: 9d4026d7730b417829537511b7a23942) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/typerep_beta";
          synopsis = "Runtime types for OCaml (Extended)";
          description =
            Some
              [
                 OASISText.Para
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("typerep_lib", None);
                           FindlibPackage ("typerep_lib.syntax", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "P\199\179\135V\138\135\205A\130\217\132\202\021\020c";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
